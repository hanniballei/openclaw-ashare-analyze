...
- The script returns a theme-level payload, top-N ranked stocks with score reasons, and representative A-share snapshots with daily indicators and money-flow data.
